...
class HttpOptions {
  ...
  // 连接服务器超时时间，单位是毫秒
  late final Duration connectTimeout = const Duration(milliseconds: 30000);
  // 接收超时时间，前后两次接受到数据的间隔，单位是毫秒
  late final Duration receiveTimeout = const Duration(milliseconds: 30000);
  ...
  HttpOptions._internal() {
    final (env, _) = getEnvironmentConfig();
    baseUrl = env == 'dev' ? DEV_BASE_URL : '';
  }
}
